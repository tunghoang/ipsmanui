export default {
  ...
  "font.Small": "小さい",
  "font.Mini": "ミニ",
  "Compiling the theme": "テーマのコンパイル",
  "Switch Language Success": "言語の切り替え成功",
  "you browser can not work": "あなたのブラウザは動作しません",
  "Switch Size Success": "スイッチサイズの成功",
  "Global Size": "サイズ",
  student: {
    addSingle: "Thêm một",
  ...
  notify : {
    text: {
      delete: 'Việc này sẽ xáo vĩnh viễn dữ liệu. Tiếp tục?'
    },
    errors: {
      '401': 'Chưa đăng nhập',
